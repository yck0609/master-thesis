...
F(:,:,1) = [0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0]; %被控系统状态方程噪声增益矩阵
F(:,:,2) = [0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0];
F(:,:,3) = [0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0;0.10 0 0 0 0 0 0 0 0];
...
axis([0 episodes-1 0 455]) %调整坐标轴范围 axis([x_min x_max y_min y_max])
